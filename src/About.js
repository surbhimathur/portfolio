...
software engineer with a reputed firm driven by technology.</p>
        <a href="https://github.com/surbhimathur/portfolio/raw/master/surbhiresumeupdate.pdf" download="surbhi_resume.pdf" className="download_link"><button className="download"><MdDownload  className="download_icon"/>Download Resume</button></a>
         </div>
       </div>
      </div>
)
