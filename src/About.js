...
software engineer with a reputed firm driven by technology.</p>
        <a href="https://drive.google.com/file/d/1_UX0-FGGVX-Nv24JrOpIrJ858qLR08u-/view?usp=sharing" target="_blank" className="download_link"><button className="download"><MdDownload  className="download_icon"/>Download Resume</button></a>
         </div>
       </div>
      </div>
)
